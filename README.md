...
1. [Yang, Z., Kwan, M. P., & Zhang, Y. (2026). Spatiotemporal associations between PM2. 5, greenspace, physical activity, and stress: a geographic ecological momentary assessment study in Hong Kong. Environmental Research, 125659.](https://www.sciencedirect.com/science/article/pii/S0013935126019900). *"First, we processed real-time GPS coordinates using the MovingPandas Python library to identify “activities” (defined as stationary points lasting >15 minutes within a 100-meter radius) and “travels” (movement between consecutive activities)"*
